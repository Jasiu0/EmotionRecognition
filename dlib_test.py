...
predictor = dlib.shape_predictor("C:\Users\Jasiu\Downloads\shape_predictor_68_face_landmarks.dat")  # Landmark identifier. Set the filename to whatever you named the downloaded file
